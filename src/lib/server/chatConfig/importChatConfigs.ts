  ...
  try {
    ...
    for (const configDir of configDirs) {
      ...
      const config: ChatConfig = {
        ...
        feedbackButtonTitle0: configJson.feedbackButtonTitle0 || 'This response is helpful',
        feedbackButtonTitle1: configJson.feedbackButtonTitle1 || 'This response is not helpful',
        feedbackButtonTitle2: configJson.feedbackButtonTitle2 || 'This response is wrong',
        feedbackButtonTitle3: configJson.feedbackButtonTitle3 || null,
        feedbackButtonTitle4: configJson.feedbackButtonTitle4 || null,
        feedbackButtonIcon0: configJson.feedbackButtonIcon0 || null,
        feedbackButtonIcon1: configJson.feedbackButtonIcon1 || null,
        feedbackButtonIcon2: configJson.feedbackButtonIcon2 || null,
        feedbackButtonIcon3: configJson.feedbackButtonIcon3 || null,
        feedbackButtonIcon4: configJson.feedbackButtonIcon4 || null,
