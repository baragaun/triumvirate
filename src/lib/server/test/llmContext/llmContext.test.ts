  ...
  describe('createChatConfig', () => {
    it('should create a new chat config', async () => {
      ...
      const result = await createChatConfig({
        ...
        feedbackButtonValue0: 'helpful',
        feedbackButtonValue1: 'not-helpful',
        feedbackButtonValue2: 'wrong',
        feedbackButtonValue3: null,
        feedbackButtonValue4: null,
        feedbackButtonLabel0: 'Helpful',
        feedbackButtonLabel1: 'Not Helpful',
        feedbackButtonLabel2: 'Wrong',
        feedbackButtonLabel3: null,
        feedbackButtonLabel4: null,
        feedbackButtonTitle0: 'This response is helpful',
        feedbackButtonTitle1: 'This response is not helpful',
        feedbackButtonTitle2: 'This response is wrong',
        feedbackButtonTitle3: null,
        feedbackButtonTitle4: null,
        feedbackButtonIcon0: null,
        feedbackButtonIcon1: null,
        feedbackButtonIcon2: null,
        feedbackButtonIcon3: null,
        feedbackButtonIcon4: null,
        feedbackButtonLlmText0: 'The user found your response helpful.',
        feedbackButtonLlmText1: 'The user did not find your response helpful.',
        feedbackButtonLlmText2: 'The user thought your response is wrong.',
        feedbackButtonLlmText3: null,
        feedbackButtonLlmText4: null,
        welcomeMessage: 'Welcome to the test',
        feedbackQuestion0: 'Some feedback question #0',
        feedbackQuestion1: 'Some feedback question #1',
        feedbackQuestion2: 'Some feedback question #2',
        feedbackQuestion3: 'Some feedback question #3',
        feedbackQuestion4: 'Some feedback question #4',
        feedbackQuestion5: 'Some feedback question #5',
        feedbackQuestion6: 'Some feedback question #6',
        feedbackQuestion7: 'Some feedback question #7',
        feedbackQuestion8: 'Some feedback question #8',
        feedbackQuestion9: 'Some feedback question #9',
        llmId: 'llm-id-123',
